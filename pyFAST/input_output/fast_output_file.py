...
if __name__ == "__main__":
    """
    B = FASTOutputFile('E:/Documents/Git/OpenFAST/openfast/reg_tests/r-test/glue-codes/openfast/5MW_Land_DLL_WTurb/5MW_Land_DLL_WTurb.SFunc.out')
    print(B.data)
    """
    df = FASTOutputFile('E:/Documents/Git/OpenFAST/openfast/reg_tests/r-test/glue-codes/openfast/5MW_Land_DLL_WTurb/5MW_Land_DLL_WTurb.SFunc.out').toDataFrame()
    time = df['Time_[s]']
    Omega = df['RotSpeed_[rpm]']
    print(time, Omega)

...
if __name__ == '__main__':
    sum = FASTSummaryFile('E:/Documents/Git/OpenFAST/python-toolbox/pyFAST/input_output/tests/example_files/FASTSum_Pendulum.SD.sum.yaml')
    print(sum['module'])    # SubDyn
    M = sum['MRB']          # Mass matrix
    K = sum['KBBt']         # stiffness matrix
    print(M, K)
    '''
    df = T.toDataFrame()
    print(df)

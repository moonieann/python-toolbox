...
'''
print(MyDir)
ref_dir = os.path.abspath('../../../data/NREL5MW/')
print(ref_dir)
'''
...
def ParametricExample():
    ...
    # Location of a FAST exe (and dll)
    ...
    avg_results = postpro.averagePostPro(outFiles, avgMethod='periods', avgParam=1, ColMap={'WS_[m/s]': 'Wind1VelX_[m/s]'}, ColKeep='RotSpeed_[rpm]', ColSort='WS_[m/s]')

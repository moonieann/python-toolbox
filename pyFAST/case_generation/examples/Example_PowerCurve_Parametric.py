...
def PowerCurveParametricExample1():
    ...
    For each dictionary:
       - their keys are "path" to a input parameter, e.g. `EDFile|RotSpeed`  or `TMax`.
           These should correspond to whatever name of the variable is used in the FAST inputs files.
